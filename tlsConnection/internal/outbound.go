...
func Outbound(ConnectionCancelFunc model.ConnectionCancelFunc, connectionType model.ConnectionType, logger *zap.Logger, opts ...rxgo.Option) common2.BoundResult {
